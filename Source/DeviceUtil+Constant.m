...
NSString* const AppleTV11_1 = @"AppleTV11,1";
...
NSString* const iPad11_6 = @"iPad11,6";
NSString* const iPad11_7 = @"iPad11,7";
...
NSString* const iPad13_18 = @"iPad13,18";
NSString* const iPad13_19 = @"iPad13,19";
...
NSString* const iPad14_3_A = @"iPad14,3-A";
NSString* const iPad14_3_B = @"iPad14,3-B";
NSString* const iPad14_4_A = @"iPad14,4-A";
NSString* const iPad14_4_B = @"iPad14,4-B";
NSString* const iPad14_5_A = @"iPad14,5-A";
NSString* const iPad14_5_B = @"iPad14,5-B";
NSString* const iPad14_6_A = @"iPad14,6-A";
NSString* const iPad14_6_B = @"iPad14,6-B";
...
NSString* const iPhone15_4 = @"iPhone15,4";
NSString* const iPhone15_5 = @"iPhone15,5";
NSString* const iPhone16_1 = @"iPhone16,1";
NSString* const iPhone16_2 = @"iPhone16,2";
...
- (Hardware)hardware {
    ...
    if ([hardware isEqualToString:AppleTV11_1]) return APPLE_TV_4K_2G;
    ...
    if ([hardware isEqualToString:iPad11_6]) return IPAD_8G_WIFI;
    if ([hardware isEqualToString:iPad11_7]) return IPAD_8G_WIFI_CELLULAR;
    ...
    if ([hardware isEqualToString:iPad13_11]) return IPAD_PRO_5_1TB_WIFI_CELLULAR;
    ...
    if ([hardware isEqualToString:iPad13_18]) return IPAD_10G_WIFI;
    if ([hardware isEqualToString:iPad13_19]) return IPAD_10G_WIFI_CELLULAR;
    ...
    if ([hardware isEqualToString:iPad13_9]) return IPAD_PRO_5_1TB_WIFI;
    ...
    if ([hardware isEqualToString:iPad14_3_A]) return IPAD_PRO_11_4G_WIFI;
    if ([hardware isEqualToString:iPad14_3_B]) return IPAD_PRO_11_3G_1TB_WIFI;
    if ([hardware isEqualToString:iPad14_4_A]) return IPAD_PRO_11_4G_WIFI_CELLULAR;
    if ([hardware isEqualToString:iPad14_4_B]) return IPAD_PRO_11_4G_1TB_WIFI_CELLULAR;
    if ([hardware isEqualToString:iPad14_5_A]) return IPAD_PRO_6G_WIFI;
    if ([hardware isEqualToString:iPad14_5_B]) return IPAD_PRO_6G_1TB_WIFI;
    if ([hardware isEqualToString:iPad14_6_A]) return IPAD_PRO_6G_WIFI_CELLULAR;
    if ([hardware isEqualToString:iPad14_6_B]) return IPAD_PRO_6G_1TB_WIFI_CELLULAR;
    ...
    if ([hardware isEqualToString:iPhone15_4]) return IPHONE_15;
    if ([hardware isEqualToString:iPhone15_5]) return IPHONE_15_PLUS;
    if ([hardware isEqualToString:iPhone16_1]) return IPHONE_15_PRO;
    if ([hardware isEqualToString:iPhone16_2]) return IPHONE_15_PRO_MAX;
